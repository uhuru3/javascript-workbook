...
const nums = strNums.map( (value,index)=>{
  return Number(value);
})
console.log(nums)
...
//using a higher order function, create an array of the unique 
// 'weather_state_name' values of the weather array. Your function should return the 
// following array ['Light Cloud', 'Heavy Cloud', 'Showers']

const weatherStates = weather.reduce((accumulator, currentValue)=>{
  if(!accumulator.includes(currentValue.weather_state_name)){
...
const idealTemp = weather.find((weatherObject)=>{
  return weatherObject.min_temp == 15.915
}).id
